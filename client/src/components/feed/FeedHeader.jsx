          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              <li className="nav-item _header_nav_item">
                <Link className="nav-link _header_nav_link_active _header_nav_link" aria-current="page" to="/" onClick={scrollToTop}>
              ...
              <li className="nav-item _header_nav_item">
                <span
                  className={`nav-link _header_nav_link _header_notify_btn${notifyOpen ? ' show' : ''}`}
                  onClick={() => setNotifyOpen((prev) => !prev)}
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => e.key === 'Enter' && setNotifyOpen((prev) => !prev)}
                >
                        ...
                        {notifications.map((item) => (
                          <div key={item.id} className="_notification_box">
                            <div className="_notification_image">
                              <img src={item.image} alt="" className="_notify_img" />
                            </div>
                              ...
                              <p className="_notification_para">
                                {item.isGroupChange ? (
                                  <>
                                    ...
                                    <span className="_notify_txt_link">{item.name}</span> to{' '}
