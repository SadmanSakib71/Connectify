...
const PostActionButtons = ({ mobile = false, onPhotoClick }) => {
  const buttons = [
        ...
        {buttons.map((btn) => (
          <div key={btn.label} className={`_feed_inner_text_area_bottom_${btn.label.toLowerCase()} _feed_common`}>
            <button
              ...
              onClick={btn.label === 'Photo' ? onPhotoClick : undefined}
            >
      ...
      <div className="_layout_middle_wrap">
        <div className="_layout_middle_inner">
          ...
          <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
            ...
            {selectedImage && (
              <p className="_mar_t8" style={{ fontSize: '13px', color: '#666' }}>
                Attached: {selectedImage.name}
              </p>
            )}

            <div className="_feed_inner_text_area_bottom">
              <PostActionButtons onPhotoClick={handlePhotoClick} />
              <div className="_feed_inner_text_area_btn">
                <select
                  className="form-select form-select-sm _mar_r8"
                  value={visibility}
            ...
            <div className="_feed_inner_text_area_bottom_mobile">
              <div className="_feed_inner_text_mobile">
                <PostActionButtons mobile onPhotoClick={handlePhotoClick} />
                <div className="_feed_inner_text_area_btn">
                  <select
                    className="form-select form-select-sm _mar_r8"
                    value={visibility}
          ...
          {error && (
            <p className="_mar_b16" style={{ color: '#c0392b', fontSize: '14px' }}>
              {error}
            </p>
          )}

          {loading && (
            <p className="_mar_b16" style={{ fontSize: '14px', color: '#666' }}>
              Loading feed...
            </p>
          )}
