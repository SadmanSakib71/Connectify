...
const timelineMenuItems = [
  ...
  { label: 'Turn On Notification', icon: 'notify' },
  { label: 'Hide', icon: 'hide' },
  { label: 'Edit Post', icon: 'edit' },
  { label: 'Delete Post', icon: 'delete' },
];

const FeedPost = ({ id, showDropdown = false }) => {
    ...
    <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
      <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
        <div className="_feed_inner_timeline_post_top">
          <div className="_feed_inner_timeline_post_box">
            <div className="_feed_inner_timeline_post_box_image">
              <img src={postImg} alt="Karim Saif" className="_post_img" />
            </div>
              ...
              <ul className="_feed_timeline_dropdown_list">
                {timelineMenuItems.map((item) => (
                  <li key={item.label} className="_feed_timeline_dropdown_item">
                    <a href="#0" className="_feed_timeline_dropdown_link">{item.label}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="_feed_inner_timeline_image">
          <img src={timelineImg} alt="Healthy Tracking App" className="_time_img" />
        </div>
      </div>

      <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
        <div className="_feed_inner_timeline_total_reacts_image">
          <img src={reactImg1} alt="" className="_react_img1" />
          <img src={reactImg2} alt="" className="_react_img" />
          <img src={reactImg3} alt="" className="_react_img _rect_img_mbl_none" />
          <img src={reactImg4} alt="" className="_react_img _rect_img_mbl_none" />
          <img src={reactImg5} alt="" className="_react_img _rect_img_mbl_none" />
          <p className="_feed_inner_timeline_total_reacts_para">9+</p>
        </div>
        <div className="_feed_inner_timeline_total_reacts_txt">
          <p className="_feed_inner_timeline_total_reacts_para1">
            {id === 1 ? <a href="#0"><span>12</span> Comment</a> : <><span>12</span> Comment</>}
          </p>
      ...
      <CommentBox textareaId={`floatingTextarea-post-${id}`} />
        ...
        <div className="_comment_main">
          <div className="_comment_image">
            <a href="/profile" className="_comment_image_link">
              <img src={txtImg} alt="Radovan SkillArena" className="_comment_img1" />
            </a>
          </div>
          <div className="_comment_area">
            <div className="_comment_details">
              <div className="_comment_details_top">
                <div className="_comment_name">
                  <a href="/profile"><h4 className="_comment_name_title">Radovan SkillArena</h4></a>
                </div>
              </div>
            ...
            <CommentBox textareaId={`floatingTextarea-reply-${id}`} />
          </div>
        </div>
      </div>
    </div>
      ...
      <form className="_feed_inner_comment_box_form" onSubmit={(e) => e.preventDefault()}>
        <div className="_feed_inner_comment_box_content">
          ...
          <div className="_feed_inner_comment_box_content_txt">
            <textarea className="form-control _comment_textarea" placeholder="Write a comment" id={textareaId} />
          </div>
        </div>
