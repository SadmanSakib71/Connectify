import { suggestedPeople, events } from './data';
      ...
      <div className="_layout_left_sidebar_wrap">
              ...
              <div key={person.id} className="_left_inner_area_suggest_info">
                <div className="_left_inner_area_suggest_info_box">
                  <div className="_left_inner_area_suggest_info_image">
                    <a href="/profile"><img src={person.image} alt={person.name} className={person.id === 1 ? '_info_img' : '_info_img1'} /></a>
                  </div>
                  <div className="_left_inner_area_suggest_info_txt">
                    <a href="/profile"><h4 className="_left_inner_area_suggest_info_title">{person.name}</h4></a>
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            {events.map((event) => (
              <a key={event.id} className="_left_inner_event_card_link" href="/event-single">
